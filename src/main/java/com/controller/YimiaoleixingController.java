...
public class YimiaoleixingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YimiaoleixingEntity yimiaoleixing, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YimiaoleixingEntity yimiaoleixing, HttpServletRequest request){
        EntityWrapper<YimiaoleixingEntity> ew = new EntityWrapper<YimiaoleixingEntity>();
		PageUtils page = yimiaoleixingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yimiaoleixing), params), params));
        return R.ok().put("data", page);
    }
