    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-input v-model="searchForm.gonghao" 
                    placeholder="ID" clearable></el-input>
              </el-form-item>
      ...
      <div class="table-content">
        <el-table
            ...
            <el-table-column
                ...
                label="Operation">
                <template slot-scope="scope">
                                                <el-button v-if="isAuth('yuangong','修改')" type="text" icon="el-icon-edit" size="small" @click="addOrUpdateHandler(scope.row.id)">Update</el-button>
                <el-button v-if="isAuth('yuangong','删除')" type="text" icon="el-icon-delete" size="small" @click="deleteHandler(scope.row.id)">Delete</el-button>
                </template>
            </el-table-column>
        </el-table>
                                                                                                                                                <el-pagination
